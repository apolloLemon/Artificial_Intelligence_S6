...
void Arbitre::initialisation()
{
  _joueur1=nullptr;
    ...
    case player::PVS_:
      _joueur1 = std::make_shared<Joueur_PVS_> ("PVS",true);
        break;
    case player::A_:
    ...
    case player::RAND:
        ...
        break;
    case player::MM_:
        _joueur1 = std::make_shared<Joueur_MiniMax_> ("MiniMax",true);
        break;
    default:
        break;
    }
    ...
    switch ((!(_numero_partie%2)? _player1 : _player2)) {
    case player::PVS_:
              _joueur2 = std::make_shared<Joueur_PVS_> ("PVS",false);
        break;
    case player::A_:
    ...
    case player::RAND:
        ...
        break;
    case player::MM_:
        _joueur2 = std::make_shared<Joueur_MiniMax_> ("MiniMax",false);
        break;
    default:
        break;
    }
